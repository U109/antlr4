...
public interface PlSqlParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#dblink}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitDblink(PlSqlParser.DblinkContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link PlSqlParser#json_condition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitJson_condition(PlSqlParser.Json_conditionContext ctx);
	/**
